...
class MySql(object):
    def __init__(self, host=None, user=None, passwd=None, db=None, charset="utf8", port=3306):
        ...
        :return:异常或者无
        """
        self.conn = pymysql.connect(host=host, user=user, passwd=passwd, db=db, charset=charset, port=port)
...
if __name__ == '__main__':
    mysqldb = MySql(host='172.16.114.233', user='metadata', passwd='metadata', db='metadata')
    print mysqldb
